...
objectId(0), objectName("Not Initiated") {}

BasicEntity::BasicEntity(ULong id, string name, string desc) : 
objectId(id), objectName(name), description(desc) {}

BasicEntity::BasicEntity(ULong id, string name, string desc, Pos2D size) : 
objectId(id), objectName(name), description(desc), entitySize(size) {}

BasicEntity::BasicEntity(string name, string desc) : 
objectName(name), description(desc) {}
